...
public class DocumentExporterSpec {
    ...
    public void breakPage() throws FileNotFoundException {
        ...
        DocumentExporter.create()
            ...
            .writeTo(new FileOutputStream(FileUtil.brotherPath(this.getClass(), "break-page.docx")));
    }
    ...
    public void mergeTable() throws FileNotFoundException {
        ...
        DocumentExporter.create()
            ...
            .writeTo(new FileOutputStream(FileUtil.brotherPath(this.getClass(), "merge-table.docx")));
    }
    ...
    public void simpleHeaderAndFooter() throws FileNotFoundException {
        ...
        DocumentExporter.create()
            ...
            .header("我是页眉")
            .footer("我是页脚")
            .writeTo(new FileOutputStream(FileUtil.brotherPath(this.getClass(), "simple-header-footer.docx")));
    }
        ...
        DocumentExporter.create()
                ...
                t.row(r -> r.headCells("姓名", "年龄", "性别", "图片", "文字图片"))
                    ...
                    .rows(people, (p, r) ->
                        r.dataCells(p::getName, p::getAge, p::getSex)
                            .pictureCell(new File(FileUtil.rootPath(this.getClass(), "/c.gif")), 20, 20)
                            .cell(c ->
                                c.text("我是单元格图片")
                                    .pictureParagraph(
            ...
            .header(HeaderFooterType.DEFAULT, h ->
                h.textParagraph("我是页眉图片")
                    .pictureParagraph(new File(FileUtil.rootPath(this.getClass(), "/b.png")), 20, 20)
            )
            // 页脚图片
